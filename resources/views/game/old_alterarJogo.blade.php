...
<div class="container"> <!-- Inicio CONTEUDO -->
    ...
    <form class="pt-4" method="post" action="{{route('alterar-jogo')}}"><!-- Inicio FORM -->
        @csrf
        <div class="row justify-content-center mt-4"><!-- Inicio SELECAO DE PERSONAGEM -->
            ...
            <div id="carouselpf" class="carousel slide p-2 col-2" data-ride="carousel" >
                ...
                <div class="carousel-inner">
                    <div class="carousel-item {{$jogo->personagem == \App\Domains\Jogo\Personagem::MINISTRA_0 ? 'active' : ''}}{{$jogo->genero == 'M' ? 'active' : ''}}">
                    ...
                    <div class="carousel-item {{$jogo->personagem == \App\Domains\Jogo\Personagem::MINISTRA_1 ? 'active' : ''}}">
                    ...
                    <div class="carousel-item {{$jogo->personagem == \App\Domains\Jogo\Personagem::MINISTRA_2 ? 'active' : ''}}">
                    ...
                    <div class="carousel-item {{$jogo->personagem == \App\Domains\Jogo\Personagem::MINISTRA_3 ? 'active' : ''}}">
                    ...
                    <div class="carousel-item {{$jogo->personagem == \App\Domains\Jogo\Personagem::MINISTRA_4 ? 'active' : ''}}">
            ...
            <input type="hidden" name="index_pf" id="index_pf" value="{{$jogo->genero == 'F' ? $jogo->personagem : '0'}}">
            ...
            <div id="carouselpm" class="carousel slide p-2 col-2" data-ride="carousel" >
                ...
                <div class="carousel-inner">
                    <div class="carousel-item {{$jogo->personagem == \App\Domains\Jogo\Personagem::MINISTRO_0 ? 'active' : ''}}{{$jogo->genero == 'F' ? 'active' : ''}}">
                    ...
                    <div class="carousel-item {{$jogo->personagem == \App\Domains\Jogo\Personagem::MINISTRO_1 ? 'active' : ''}}">
                    ...
                    <div class="carousel-item {{$jogo->personagem == \App\Domains\Jogo\Personagem::MINISTRO_2 ? 'active' : ''}}">
                    ...
                    <div class="carousel-item {{$jogo->personagem == \App\Domains\Jogo\Personagem::MINISTRO_3 ? 'active' : ''}}">
                    ...
                    <div class="carousel-item {{$jogo->personagem == \App\Domains\Jogo\Personagem::MINISTRO_4 ? 'active' : ''}}">
            ...
            <input type="hidden" name="index_pm" id="index_pm" value="{{$jogo->genero == 'M' ? $jogo->personagem : '0'}}">
        ...
        <div class="row justify-content-center mb-2"><!-- Inicio SELECAO DE SEXO -->
            ...
            <div class="custom-control custom-radio custom-control-inline col-2 justify-content-center m-0" >
                <input type="radio" name="genero" class="custom-control-input" id="selecao-sexo-f" value="F" {{$jogo->genero == 'F' ? 'checked' : ''}}>
                <label class="custom-control-label text-form01" style="cursor: pointer;" for="selecao-sexo-f">MINISTRA</label>
            </div>

            <div class="custom-control custom-radio custom-control-inline col-2 justify-content-center m-0">
                <input type="radio" name="genero" class="custom-control-input" id="selecao-sexo-m"  value="M" {{$jogo->genero == 'M' ? 'checked' : ''}}>
        ...
        <div class="form-row mb-4 justify-content-center">
            <div class="col-3">
                ...
                <input type="text" name="pais" value="{{$jogo->pais}}" id="pais" class="form-control text-form02" placeholder="Ex: Brasil, China...">
            </div>
            <div class="col-3">
                <label for="moeda"><p class="text-form01 mb-0">MOEDA</p></label>
                <input type="text" name="moeda" value="{{$jogo->moeda}}" id="moeda" class="form-control text-form02" placeholder="Inserir no plural">
            </div>
        </div>
        ...
        <div class="form-row mb-4 justify-content-center">
            <div class="col-3">
                ...
                <input type="text" name="ministro" value="{{$jogo->ministro}}" id="ministro" class="form-control text-form02" placeholder="Esse será você!">
            </div>
            <div class="col-3">
                <label for="presidente"><p class="text-form01 mb-0">PRESIDENTE</p></label>
                <input type="text" name="presidente" value="{{$jogo->presidente}}" id="presidente" class="form-control text-form02" placeholder="E esse seu chefe">
            </div>
        </div>
        ...
        <div class="form-row mb-4 justify-content-center">
            <div class="col-5">
                ...
                <input type="text" name="descricao" value="{{$jogo->descricao}}" id="descri-economia" class="form-control text-form02" placeholder="Breve descrição">
            </div>

            <div class="col-1">
                <label for="quantity"><p class="text-form01 mb-0">TURNOS</p></label><br>
                <input type="number" name="rodadas" value="{{$jogo->rodadas}}" id="quantity" class="form-control text-form02" min="10" max="500" placeholder="10">
            </div>
        </div>

        <div class="form-row mb-4 justify-content-center">
            <button class="btn btn-block bg-botoes col-4 mx-auto mt-4 mb-4 p-2 text-menu text-center" type="submit">Alterar!</button>
        </div>
    </form><!-- Fim FORM -->
...
<script type="text/javascript">
    ...
    $('#carouselpf').on('slid.bs.carousel', function () {
        console.log($('#carouselpf div.active').index());
