...
<head>
    ...
    <title>Registro - Economy Simulator</title>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="text-center"><br>Cadastro</h2>
            </div>
            <div class="modal-body">
                <form class="form col-md-12 center-block" method="post" action="{{route('register')}}">
                    @csrf
                    <div class="form-group">
                        <input type="text" class="form-control input-lg" name="name" value="{{old('name')}}" placeholder="Nome">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control input-lg" name="password_confirmation" placeholder="Repita a senha">
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                <span class="pull-right"><a href="{{route('login')}}">Entrar</a></span>
            </div>
        </div>
    </div>
</div>
